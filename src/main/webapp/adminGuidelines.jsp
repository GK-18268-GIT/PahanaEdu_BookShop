...
<head>
  ...
  <title>PahanaEdu - Admin Guidelines</title>
...
<body>
    ...
    <ul>
        <li>Registration: Register new admin to the system</li>
        <li>Use your email and password to login to the system </li>
        <li>After login to the system you can navigate to the "Add new customer", "Manage Items", ""Display account details", and "Edit customer data"" </li>
    </ul>
    ...
    <ul>
        <li>Add new items to the system</li>
        <li>Update item information and prices</li>
        <li>Manage stock level</li>
        <li>Categorize items appropriately</li>
    </ul>
